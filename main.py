...
def compare_files(path1:str, path2:str, column):
    ...
    # Using the vectorized `isin` method is significantly faster than converting
    # to sets for finding differences, as it leverages pandas' internal optimizations.
    data_in_df1_not_in_df2 = df1[column][~df1[column].isin(df2[column])].unique()
